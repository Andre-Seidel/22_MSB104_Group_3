...
@tbl-mlr-germany shows shows the highest value of R2 in model 3.
...
Furthermore, we will test whether the variables from earlier have an effect on growth and inequality in the three countries Germany, Finland and Romania.
...
First, an assumption is made about the distribution, this is called the null hypothesis and referred to as H0.
