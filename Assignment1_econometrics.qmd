...
-- theory for using hypothesis testing for inference --
...
We can reject H0 since t is larger than tcrit.
This means that education have an effect on regional inequality.
...
We can not reject H0 since t is smaller than tcrit.
This means that motorway does not have an effect on regional inequality.
...
We can reject H0 since t is larger than tcrit.
This means that life expectancy age have an effect on regional inequality.
