...
From the table it appears that it is the regions Wolfsburg, Ingolstadt and München who are the wealthiest regions in Germany.
...
Südwestpfalz, Kusel and Rhein-Pfalz-Kreis are the least wealthy regions in the country.
...
Helsinki-Uusimaa, Åland and Ostrobothnia is the most wealthy regions in Finland.
Compared to the least wealthy regions Etelä-Savo, Päijät-Häme and Kainuu we can see that the most wealthy regions is not even twice the value as the least wealthy regions.
...
Bucharest, Cluj Country and Timis Country is the most wealthy regions in Romaina.
The least wealthy regions in the country is Vaslui Country, Giurgiu Country and Botosani Country.
