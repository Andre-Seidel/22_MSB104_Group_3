...
From the plot we see the coefficient R2 which can tell us the fit to the model.
...
As we already mentioned the data set for Finland only gives us 3 values/regions for 2010.
@tbl-mlr-finland shows a high value for R2 with model 1,3,4 and 5 however we cant conclude anything useful with so little data.
