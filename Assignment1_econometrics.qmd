...
```
In the plot for Finland we see that the points are placed close to the regression line. At first glance, it appears that the model has a strong goodness to fit. But due to very little data for the selected country to compare, it is difficult to describe the real relationship from the plot. 
