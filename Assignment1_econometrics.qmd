...
There are two regions with a perfect score of 0.0. This could be an indicator that there is something wrong or missing in the data set for these regions.
...
We can see that Finland also have two regions with a perfect score of 0.0. Here we also suspect that there is something missing in the data set.
