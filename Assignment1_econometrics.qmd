...
lm.4 = lm(gini ~ eduval , mdata) 
lm.5 = lm(gini ~  motorway, mdata)
lm.6 = lm(gini ~ eduval + motorway, mdata)
#Gen Table
  huxreg(
...
```{r}
lm.4 = lm(gini ~ eduval , mdata) 
lm.5 = lm(gini ~  lifeexpectancyage, mdata)
lm.6 = lm(gini ~ eduval + lifeexpectancyage, mdata)
#Gen Table
  huxreg(
  list("Model 1" = lm.4, "Model 2" = lm.5, "Model 3" = lm.6),
  statistics = c(N = "nobs", R2 = "r.squared"),
